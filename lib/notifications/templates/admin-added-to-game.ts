type AdminAddedToGameTemplateProps = {
  gameDate: string;
  gameUrl: string;
};
...
export function adminAddedToGameTemplate({
  gameDate,
  gameUrl,
}: AdminAddedToGameTemplateProps) {
  ...
  return {
    ...
    text: [
      "ESTÁS DENTRO",
      "",
      `Um organizador adicionou-te ao jogo de ${gameDate}.`,
      "",
...
<html lang="pt">
  <head>
    ...
    <title>Foste adicionado a um jogo</title>
  </head>
  <body style="margin:0;padding:0;background:#f5f7fa;color:#101828;font-family:Inter,Helvetica Neue,Arial,sans-serif;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
      Um organizador adicionou-te a um jogo do Voley Lisboa.
    </div>
            ...
            <tr>
              <td style="padding:28px;">
                <p style="margin:0 0 20px;color:#101828;font-size:16px;line-height:24px;">
                  Um organizador adicionou-te a este jogo.
                </p>
                ...
                <p style="margin:24px 0 0;padding-top:18px;border-top:1px solid #dde2ea;color:#667085;font-size:12px;line-height:18px;">
                  Esta mensagem foi enviada porque um organizador te adicionou ao jogo.
                </p>
              </td>
            </tr>
          </table>
