  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#fff8d8] px-4 py-16 text-[rgba(0,0,0,0.87)] sm:px-6">
      <section className="w-full max-w-md rounded-xl bg-white px-6 py-8 text-center shadow-[0_0_0.5px_0_rgba(0,0,0,0.14),0_1px_1px_0_rgba(0,0,0,0.24)] sm:px-8">
        ...
        <p className="mt-3 text-base leading-7 text-[#26375f]">
          {t("notFoundIntro")}
        </p>
        <Link
          href="/dashboard"
          className="ripple ripple-dark mt-6 inline-flex rounded-full border border-[#0737a8] bg-white px-5 py-3 text-sm font-semibold text-[#0737a8] transition active:scale-95"
        >
          {t("backToGames")}
        </Link>
      </section>
